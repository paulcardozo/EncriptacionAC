...
public class TwoTimePad {
	...
	private String xorChar(String message, String llave) {
		String s = "";
	...
	private String xorMessage(String ca, String mes) {
		int cont = 0;
		String resultado = "";
		String aux = "";
		String auxCA = "";
	...
	public long encrypt(String message) {
		...
		String encrypted = xorMessage(key, binaryResult);
		String result = "";
		int cont = 0;
		for (int i = 0; i < length; i++) { 
	...
	public long encryptJavaRandom(String message) {
		...
		String encrypted = xorMessage(resC, binaryResult);
		String result = "";
		int cont = 0;
		for (int i = 0; i < length; i++) {
			String aux = encrypted.substring(cont, cont + 8);
	...
	public static void main(String args[]) {
		...
		TwoTimePad otp = new TwoTimePad();
		//otp.dataGenerator(str);
		System.out.println();
		System.out.println("Mensaje original: Mensaje de prueba");
		String encryptedMessage = otp.encrypting("Mensaje de prueba");
		otp.decrypt(encryptedMessage);
	}
}
